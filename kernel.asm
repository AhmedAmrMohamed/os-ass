...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 83 79 10 80 	movl   $0x80107983,(%esp)
...
80101ec8:	68 6a 77 10 80       	push   $0x8010776a
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 85 3a 00 00       	call   80106910 <switchkvm>
  seginit();
80102e8b:	e8 f0 39 00 00       	call   80106880 <seginit>
  lapicinit();
...
80102ec1:	e8 1a 3f 00 00       	call   80106de0 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 ab 39 00 00       	call   80106880 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 67 2c 00 00       	call   80105b50 <uartinit>
  pinit();         // process table
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
80103636:	a1 08 a0 10 80       	mov    0x8010a008,%eax
  p->tickets = 1;
  release(&ptable.lock);
...
80103652:	68 40 2d 11 80       	push   $0x80112d40
  p->pid = nextpid++;
80103657:	89 15 08 a0 10 80    	mov    %edx,0x8010a008
  release(&ptable.lock);
...
8010367f:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103682:	c7 40 14 88 57 10 80 	movl   $0x80105788,0x14(%eax)
  p->context = (struct context*)sp;
...
80103736:	68 55 75 10 80       	push   $0x80107555
...
801038bf:	68 85 75 10 80       	push   $0x80107585
801038c4:	50                   	push   %eax
801038c5:	e8 56 0e 00 00       	call   80104720 <safestrcpy>
  p->cwd = namei("/");
801038ca:	c7 04 24 8e 75 10 80 	movl   $0x8010758e,(%esp)
...
80103903:	68 6c 75 10 80       	push   $0x8010756c
...
80103aca:	8d 40 04             	lea    0x4(%eax),%eax
80103acd:	89 45 e0             	mov    %eax,-0x20(%ebp)
  asm volatile("sti");
80103ad0:	fb                   	sti    
...
80103ad1:	69 05 b8 a5 10 80 ee 	imul   $0x3bee,0x8010a5b8,%eax
80103ad8:	3b 00 00 
    acquire(&ptable.lock);
80103adb:	83 ec 0c             	sub    $0xc,%esp
	int ticketcnt = 0;
80103ade:	31 db                	xor    %ebx,%ebx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ae0:	bf 74 2d 11 80       	mov    $0x80112d74,%edi
    acquire(&ptable.lock);
80103ae5:	68 40 2d 11 80       	push   $0x80112d40
	prev = (prev * Arand + Crand)% totaltickets;
80103aea:	05 8a b0 00 00       	add    $0xb08a,%eax
80103aef:	99                   	cltd   
80103af0:	f7 3d 04 a0 10 80    	idivl  0x8010a004
80103af6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80103af9:	89 15 b8 a5 10 80    	mov    %edx,0x8010a5b8
    acquire(&ptable.lock);
80103aff:	e8 2c 09 00 00       	call   80104430 <acquire>
80103b04:	83 c4 10             	add    $0x10,%esp
80103b07:	89 f6                	mov    %esi,%esi
80103b09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      if(p->state != RUNNABLE)
80103b10:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103b14:	75 3d                	jne    80103b53 <scheduler+0xa3>
	  ticketcnt += p->tickets;
80103b16:	03 5f 7c             	add    0x7c(%edi),%ebx
	  if(ticketcnt < ticketwin)
80103b19:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
80103b1c:	7c 35                	jl     80103b53 <scheduler+0xa3>
      switchuvm(p);
80103b1e:	83 ec 0c             	sub    $0xc,%esp
      c->proc = p;
80103b21:	89 be ac 00 00 00    	mov    %edi,0xac(%esi)
      switchuvm(p);
80103b27:	57                   	push   %edi
80103b28:	e8 03 2e 00 00       	call   80106930 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103b2d:	58                   	pop    %eax
80103b2e:	5a                   	pop    %edx
80103b2f:	ff 77 1c             	pushl  0x1c(%edi)
80103b32:	ff 75 e0             	pushl  -0x20(%ebp)
      p->state = RUNNING;
80103b35:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p->context);
80103b3c:	e8 3a 0c 00 00       	call   8010477b <swtch>
      switchkvm();
80103b41:	e8 ca 2d 00 00       	call   80106910 <switchkvm>
      c->proc = 0;
80103b46:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b4d:	00 00 00 
80103b50:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b53:	83 ef 80             	sub    $0xffffff80,%edi
80103b56:	81 ff 74 4d 11 80    	cmp    $0x80114d74,%edi
80103b5c:	72 b2                	jb     80103b10 <scheduler+0x60>
    release(&ptable.lock);
80103b5e:	83 ec 0c             	sub    $0xc,%esp
80103b61:	68 40 2d 11 80       	push   $0x80112d40
80103b66:	e8 85 09 00 00       	call   801044f0 <release>
  for(;;){
80103b6b:	83 c4 10             	add    $0x10,%esp
80103b6e:	e9 5d ff ff ff       	jmp    80103ad0 <scheduler+0x20>
80103b73:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
...
80103b84:	53                   	push   %ebx
  pushcli();
80103b85:	e8 d6 07 00 00       	call   80104360 <pushcli>
  c = mycpu();
80103b8a:	e8 c1 fb ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103b8f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b95:	e8 06 08 00 00       	call   801043a0 <popcli>
  if(!holding(&ptable.lock))
80103b9a:	83 ec 0c             	sub    $0xc,%esp
80103b9d:	68 40 2d 11 80       	push   $0x80112d40
80103ba2:	e8 59 08 00 00       	call   80104400 <holding>
...
80103bc7:	75 41                	jne    80103c0a <sched+0x8a>
  intena = mycpu()->intena;
80103bc9:	e8 82 fb ff ff       	call   80103750 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103bce:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103bd1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103bd7:	e8 74 fb ff ff       	call   80103750 <mycpu>
80103bdc:	83 ec 08             	sub    $0x8,%esp
80103bdf:	ff 70 04             	pushl  0x4(%eax)
80103be2:	53                   	push   %ebx
80103be3:	e8 93 0b 00 00       	call   8010477b <swtch>
  mycpu()->intena = intena;
80103be8:	e8 63 fb ff ff       	call   80103750 <mycpu>
}
...
80103d17:	75 e7                	jne    80103d00 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d19:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103d1e:	eb 0a                	jmp    80103d2a <exit+0xea>
80103d20:	83 e8 80             	sub    $0xffffff80,%eax
80103d23:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
...
80103d45:	8b 46 7c             	mov    0x7c(%esi),%eax
80103d48:	29 05 04 a0 10 80    	sub    %eax,0x8010a004
  sched();
80103d4e:	e8 2d fe ff ff       	call   80103b80 <sched>
  panic("zombie exit");
80103d53:	83 ec 0c             	sub    $0xc,%esp
80103d56:	68 dd 75 10 80       	push   $0x801075dd
80103d5b:	e8 30 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d60:	83 ec 0c             	sub    $0xc,%esp
80103d63:	68 d0 75 10 80       	push   $0x801075d0
...
80103d77:	68 40 2d 11 80       	push   $0x80112d40
80103d7c:	e8 af 06 00 00       	call   80104430 <acquire>
  pushcli();
80103d81:	e8 da 05 00 00       	call   80104360 <pushcli>
  c = mycpu();
80103d86:	e8 c5 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103d8b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d91:	e8 0a 06 00 00       	call   801043a0 <popcli>
...
80103da9:	e8 42 07 00 00       	call   801044f0 <release>
}
...
80103dcc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103dcf:	e8 8c 05 00 00       	call   80104360 <pushcli>
  c = mycpu();
80103dd4:	e8 77 f9 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103dd9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ddf:	e8 bc 05 00 00       	call   801043a0 <popcli>
  if(p == 0)
...
80103e2a:	e8 c1 06 00 00       	call   801044f0 <release>
    acquire(lk);
...
80103e3b:	5d                   	pop    %ebp
    acquire(lk);
80103e3c:	e9 ef 05 00 00       	jmp    80104430 <acquire>
...
80103e69:	68 ef 75 10 80       	push   $0x801075ef
80103e6e:	e8 1d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e73:	83 ec 0c             	sub    $0xc,%esp
80103e76:	68 e9 75 10 80       	push   $0x801075e9
...
80103e84:	53                   	push   %ebx
  pushcli();
80103e85:	e8 d6 04 00 00       	call   80104360 <pushcli>
  c = mycpu();
80103e8a:	e8 c1 f8 ff ff       	call   80103750 <mycpu>
  p = c->proc;
80103e8f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e95:	e8 06 05 00 00       	call   801043a0 <popcli>
  acquire(&ptable.lock);
80103e9a:	83 ec 0c             	sub    $0xc,%esp
80103e9d:	68 40 2d 11 80       	push   $0x80112d40
80103ea2:	e8 89 05 00 00       	call   80104430 <acquire>
80103ea7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103eaa:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eac:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
80103eb1:	eb 10                	jmp    80103ec3 <wait+0x43>
80103eb3:	90                   	nop
80103eb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103eb8:	83 eb 80             	sub    $0xffffff80,%ebx
80103ebb:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
...
80103ed1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ed6:	81 fb 74 4d 11 80    	cmp    $0x80114d74,%ebx
...
80103f12:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f19:	e8 c2 2d 00 00       	call   80106ce0 <freevm>
        release(&ptable.lock);
80103f1e:	c7 04 24 40 2d 11 80 	movl   $0x80112d40,(%esp)
        p->pid = 0;
...
80103f3e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f45:	e8 a6 05 00 00       	call   801044f0 <release>
        return pid;
...
80103f59:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f5e:	68 40 2d 11 80       	push   $0x80112d40
80103f63:	e8 88 05 00 00       	call   801044f0 <release>
      return -1;
...
80103f77:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103f7a:	68 40 2d 11 80       	push   $0x80112d40
80103f7f:	e8 ac 04 00 00       	call   80104430 <acquire>
80103f84:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f87:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103f8c:	eb 0c                	jmp    80103f9a <wakeup+0x2a>
80103f8e:	66 90                	xchg   %ax,%ax
80103f90:	83 e8 80             	sub    $0xffffff80,%eax
80103f93:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
...
80103faf:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
80103fb4:	72 e4                	jb     80103f9a <wakeup+0x2a>
  release(&ptable.lock);
80103fb6:	c7 45 08 40 2d 11 80 	movl   $0x80112d40,0x8(%ebp)
}
80103fbd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103fc0:	c9                   	leave  
  release(&ptable.lock);
80103fc1:	e9 2a 05 00 00       	jmp    801044f0 <release>
...
80103fd7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
80103fda:	68 40 2d 11 80       	push   $0x80112d40
80103fdf:	e8 4c 04 00 00       	call   80104430 <acquire>
80103fe4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fe7:	b8 74 2d 11 80       	mov    $0x80112d74,%eax
80103fec:	eb 0c                	jmp    80103ffa <kill+0x2a>
80103fee:	66 90                	xchg   %ax,%ax
80103ff0:	83 e8 80             	sub    $0xffffff80,%eax
80103ff3:	3d 74 4d 11 80       	cmp    $0x80114d74,%eax
...
8010401b:	e8 d0 04 00 00       	call   801044f0 <release>
      return 0;
...
80104033:	68 40 2d 11 80       	push   $0x80112d40
80104038:	e8 b3 04 00 00       	call   801044f0 <release>
  return -1;
...
80104056:	8d 75 e8             	lea    -0x18(%ebp),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104059:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
{
...
8010408e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104091:	ba 00 76 10 80       	mov    $0x80107600,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104096:	77 11                	ja     801040a9 <procdump+0x59>
80104098:	8b 14 85 60 76 10 80 	mov    -0x7fef89a0(,%eax,4),%edx
      state = "???";
8010409f:	b8 00 76 10 80       	mov    $0x80107600,%eax
...
801040b1:	68 04 76 10 80       	push   $0x80107604
...
801040d8:	e8 33 02 00 00       	call   80104310 <getcallerpcs>
...
801040ed:	68 41 70 10 80       	push   $0x80107041
...
80104115:	53                   	push   %ebx
  	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104116:	bb 74 2d 11 80       	mov    $0x80112d74,%ebx
{
8010411b:	83 ec 18             	sub    $0x18,%esp
8010411e:	8b 7d 08             	mov    0x8(%ebp),%edi
80104121:	8b 75 0c             	mov    0xc(%ebp),%esi
	acquire(&ptable.lock);
80104124:	68 40 2d 11 80       	push   $0x80112d40
80104129:	e8 02 03 00 00       	call   80104430 <acquire>
8010412e:	83 c4 10             	add    $0x10,%esp
80104131:	eb 10                	jmp    80104143 <mysettickets+0x33>
80104133:	90                   	nop
...
80104141:	73 2d                	jae    80104170 <mysettickets+0x60>
		if(p->pid == pid) 
80104143:	39 73 10             	cmp    %esi,0x10(%ebx)
80104146:	75 f0                	jne    80104138 <mysettickets+0x28>
			release(&ptable.lock);
80104148:	83 ec 0c             	sub    $0xc,%esp
			p->tickets = number;
8010414b:	89 7b 7c             	mov    %edi,0x7c(%ebx)
			totaltickets += number;
8010414e:	01 3d 04 a0 10 80    	add    %edi,0x8010a004
			release(&ptable.lock);
80104154:	68 40 2d 11 80       	push   $0x80112d40
80104159:	e8 92 03 00 00       	call   801044f0 <release>
			return p->pid;
8010415e:	8b 43 10             	mov    0x10(%ebx),%eax
80104161:	83 c4 10             	add    $0x10,%esp
}
80104164:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104167:	5b                   	pop    %ebx
80104168:	5e                   	pop    %esi
80104169:	5f                   	pop    %edi
8010416a:	5d                   	pop    %ebp
...
80104173:	68 40 2d 11 80       	push   $0x80112d40
80104178:	e8 73 03 00 00       	call   801044f0 <release>
	return -1;
...
80104190 <randomint>:
	prev = (prev * Arand + Crand)% totaltickets;
80104190:	69 05 b8 a5 10 80 ee 	imul   $0x3bee,0x8010a5b8,%eax
80104197:	3b 00 00 
{
...
8010419d:	5d                   	pop    %ebp
	prev = (prev * Arand + Crand)% totaltickets;
8010419e:	05 8a b0 00 00       	add    $0xb08a,%eax
801041a3:	99                   	cltd   
801041a4:	f7 3d 04 a0 10 80    	idivl  0x8010a004
}
801041aa:	89 d0                	mov    %edx,%eax
	prev = (prev * Arand + Crand)% totaltickets;
801041ac:	89 15 b8 a5 10 80    	mov    %edx,0x8010a5b8
}
801041b2:	c3                   	ret    
801041b3:	66 90                	xchg   %ax,%ax
801041b5:	66 90                	xchg   %ax,%ax
...
801041ca:	68 80 76 10 80       	push   $0x80107680
...
80104225:	e8 96 fb ff ff       	call   80103dc0 <sleep>
  while (lk->locked) {
...
80104284:	e8 e7 fc ff ff       	call   80103f70 <wakeup>
  release(&lk->lk);
...
801043e5:	68 8b 76 10 80       	push   $0x8010768b
801043ea:	e8 a1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043ef:	83 ec 0c             	sub    $0xc,%esp
801043f2:	68 a2 76 10 80       	push   $0x801076a2
...
801044d7:	68 a9 76 10 80       	push   $0x801076a9
...
8010452c:	68 b1 76 10 80       	push   $0x801076b1
...
80104947:	83 fa 17             	cmp    $0x17,%edx
8010494a:	77 1c                	ja     80104968 <syscall+0x38>
8010494c:	8b 14 85 e0 76 10 80 	mov    -0x7fef8920(,%eax,4),%edx
...
80104970:	68 b9 76 10 80       	push   $0x801076b9
...
80104ac4:	68 60 77 10 80       	push   $0x80107760
...
80104adc:	68 5f 77 10 80       	push   $0x8010775f
...
80104af5:	68 53 77 10 80       	push   $0x80107753
...
80104b0a:	68 62 77 10 80       	push   $0x80107762
80104b0f:	e8 7c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104b14:	83 ec 0c             	sub    $0xc,%esp
80104b17:	68 44 77 10 80       	push   $0x80107744
...
80104b54:	e8 97 ec ff ff       	call   801037f0 <myproc>
...
80104b99:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104b9b:	e8 50 ec ff ff       	call   801037f0 <myproc>
...
80104c3a:	ff 75 ec             	pushl  -0x14(%ebp)
  ++bf_readcount;
80104c3d:	83 05 c0 a5 10 80 01 	addl   $0x1,0x8010a5c0
  return fileread(f, p, n);
80104c44:	e8 17 c3 ff ff       	call   80100f60 <fileread>
...
80104ce3:	78 2b                	js     80104d10 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104ce5:	e8 06 eb ff ff       	call   801037f0 <myproc>
...
80104f09:	58                   	pop    %eax
80104f0a:	5a                   	pop    %edx
80104f0b:	68 60 77 10 80       	push   $0x80107760
...
80104f24:	68 5f 77 10 80       	push   $0x8010775f
...
8010511f:	0f 84 a6 00 00 00    	je     801051cb <sys_open+0x12b>
  struct proc *curproc = myproc();
80105125:	e8 c6 e6 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054cf:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801054d1:	e8 1a e3 ff ff       	call   801037f0 <myproc>
...
801054f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801054fa:	e8 f1 e2 ff ff       	call   801037f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105531:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105538:	e8 b3 e2 ff ff       	call   801037f0 <myproc>
...
80105573:	5d                   	pop    %ebp
  return fork();
80105574:	e9 17 e4 ff ff       	jmp    80103990 <fork>
...
80105583:	83 ec 08             	sub    $0x8,%esp
  exit();
80105586:	e8 b5 e6 ff ff       	call   80103c40 <exit>
...
80105593:	5d                   	pop    %ebp
  return wait();
80105594:	e9 e7 e8 ff ff       	jmp    80103e80 <wait>
...
801055be:	e8 0d ea ff ff       	call   80103fd0 <kill>
...
801055e3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801055e6:	e8 05 e2 ff ff       	call   801037f0 <myproc>
...
80105607:	78 27                	js     80105630 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105609:	e8 e2 e1 ff ff       	call   801037f0 <myproc>
  if(growproc(n) < 0)
...
80105616:	e8 f5 e2 ff ff       	call   80103910 <growproc>
...
80105660:	68 80 4d 11 80       	push   $0x80114d80
...
8010566d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105670:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  while(ticks - ticks0 < n){
...
80105683:	68 80 4d 11 80       	push   $0x80114d80
80105688:	68 c0 55 11 80       	push   $0x801155c0
8010568d:	e8 2e e7 ff ff       	call   80103dc0 <sleep>
  while(ticks - ticks0 < n){
80105692:	a1 c0 55 11 80       	mov    0x801155c0,%eax
...
8010569f:	73 2f                	jae    801056d0 <sys_sleep+0x90>
    if(myproc()->killed){
801056a1:	e8 4a e1 ff ff       	call   801037f0 <myproc>
...
801056b0:	68 80 4d 11 80       	push   $0x80114d80
...
801056d3:	68 80 4d 11 80       	push   $0x80114d80
...
801056f4:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
801056f7:	68 80 4d 11 80       	push   $0x80114d80
801056fc:	e8 2f ed ff ff       	call   80104430 <acquire>
  xticks = ticks;
80105701:	8b 1d c0 55 11 80    	mov    0x801155c0,%ebx
  release(&tickslock);
80105707:	c7 04 24 80 4d 11 80 	movl   $0x80114d80,(%esp)
...
80105721:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
{
...
8010573c:	e8 ff f0 ff ff       	call   80104840 <argint>
	pid = myproc()->pid;
80105741:	e8 aa e0 ff ff       	call   801037f0 <myproc>
	return mysettickets(number,pid);
80105746:	5a                   	pop    %edx
80105747:	59                   	pop    %ecx
80105748:	ff 70 10             	pushl  0x10(%eax)
8010574b:	ff 75 f4             	pushl  -0xc(%ebp)
8010574e:	e8 bd e9 ff ff       	call   80104110 <mysettickets>
}
80105753:	c9                   	leave  
80105754:	c3                   	ret    
80105755:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105759:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

80105760 <sys_gettickets>:
...
80105766:	e8 85 e0 ff ff       	call   801037f0 <myproc>
8010576b:	8b 40 7c             	mov    0x7c(%eax),%eax
}
8010576e:	c9                   	leave  
8010576f:	c3                   	ret    
...
80105771:	06                   	push   %es
  pushl %fs
80105772:	0f a0                	push   %fs
  pushl %gs
80105774:	0f a8                	push   %gs
  pushal
80105776:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105777:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010577b:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010577d:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010577f:	54                   	push   %esp
  call trap
80105780:	e8 cb 00 00 00       	call   80105850 <trap>
  addl $4, %esp
80105785:	83 c4 04             	add    $0x4,%esp
...
80105788:	61                   	popa   
  popl %gs
80105789:	0f a9                	pop    %gs
  popl %fs
8010578b:	0f a1                	pop    %fs
  popl %es
8010578d:	07                   	pop    %es
  popl %ds
8010578e:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
8010578f:	83 c4 08             	add    $0x8,%esp
  iret
80105792:	cf                   	iret   
80105793:	66 90                	xchg   %ax,%ax
80105795:	66 90                	xchg   %ax,%ax
...
801057b0:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
...
801057df:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
...
801057ee:	00 00 ef 
  initlock(&tickslock, "time");
801057f1:	68 a5 77 10 80       	push   $0x801077a5
...
80105804:	66 a3 c6 4f 11 80    	mov    %ax,0x80114fc6
  initlock(&tickslock, "time");
8010580a:	e8 e1 ea ff ff       	call   801042f0 <initlock>
}
...
80105870:	ff 24 85 4c 78 10 80 	jmp    *-0x7fef87b4(,%eax,4)
...
801058d5:	68 08 78 10 80       	push   $0x80107808
...
8010596d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105970:	e8 bb ef ff ff       	call   80104930 <syscall>
    if(myproc()->killed)
...
801059c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801059c8:	e8 43 cc ff ff       	call   80102610 <kbdintr>
    lapiceoi();
...
801059e8:	e8 53 02 00 00       	call   80105c40 <uartintr>
    lapiceoi();
801059ed:	e8 5e cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105a17:	68 b0 77 10 80       	push   $0x801077b0
80105a1c:	e8 3f ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105a21:	e8 2a cd ff ff       	call   80102750 <lapiceoi>
    break;
...
80105ab5:	68 d4 77 10 80       	push   $0x801077d4
80105aba:	e8 a1 ab ff ff       	call   80100660 <cprintf>
      panic("trap");
80105abf:	83 c4 14             	add    $0x14,%esp
80105ac2:	68 aa 77 10 80       	push   $0x801077aa
...
{
  if(!uart)
80105ad0:	a1 c4 a5 10 80       	mov    0x8010a5c4,%eax
{
...
80105b25:	e8 46 cc ff ff       	call   80102770 <microdelay>
...
80105ba7:	74 5a                	je     80105c03 <uartinit+0xb3>
  uart = 1;
80105ba9:	c7 05 c4 a5 10 80 01 	movl   $0x1,0x8010a5c4
80105bb0:	00 00 00 
...
80105bbc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105bbf:	bb cc 78 10 80       	mov    $0x801078cc,%ebx
  ioapicenable(IRQ_COM1, 0);
80105bc4:	6a 00                	push   $0x0
80105bc6:	6a 04                	push   $0x4
80105bc8:	e8 03 c7 ff ff       	call   801022d0 <ioapicenable>
...
80105be8:	74 19                	je     80105c03 <uartinit+0xb3>
  if(!uart)
80105bea:	8b 15 c4 a5 10 80    	mov    0x8010a5c4,%edx
...
80105c10 <uartputc>:
  if(!uart)
80105c10:	8b 15 c4 a5 10 80    	mov    0x8010a5c4,%edx
{
...
80105c57:	6a 00                	push   $0x0
  jmp alltraps
80105c59:	e9 12 fb ff ff       	jmp    80105770 <alltraps>
...
80105c60:	6a 01                	push   $0x1
  jmp alltraps
80105c62:	e9 09 fb ff ff       	jmp    80105770 <alltraps>
...
80105c69:	6a 02                	push   $0x2
  jmp alltraps
80105c6b:	e9 00 fb ff ff       	jmp    80105770 <alltraps>
...
80105c72:	6a 03                	push   $0x3
  jmp alltraps
80105c74:	e9 f7 fa ff ff       	jmp    80105770 <alltraps>
...
80105c7b:	6a 04                	push   $0x4
  jmp alltraps
80105c7d:	e9 ee fa ff ff       	jmp    80105770 <alltraps>
...
80105c84:	6a 05                	push   $0x5
  jmp alltraps
80105c86:	e9 e5 fa ff ff       	jmp    80105770 <alltraps>
...
80105c8d:	6a 06                	push   $0x6
  jmp alltraps
80105c8f:	e9 dc fa ff ff       	jmp    80105770 <alltraps>
...
80105c96:	6a 07                	push   $0x7
  jmp alltraps
80105c98:	e9 d3 fa ff ff       	jmp    80105770 <alltraps>
...
80105c9d:	6a 08                	push   $0x8
  jmp alltraps
80105c9f:	e9 cc fa ff ff       	jmp    80105770 <alltraps>
...
80105ca6:	6a 09                	push   $0x9
  jmp alltraps
80105ca8:	e9 c3 fa ff ff       	jmp    80105770 <alltraps>
...
80105cad:	6a 0a                	push   $0xa
  jmp alltraps
80105caf:	e9 bc fa ff ff       	jmp    80105770 <alltraps>
...
80105cb4:	6a 0b                	push   $0xb
  jmp alltraps
80105cb6:	e9 b5 fa ff ff       	jmp    80105770 <alltraps>
...
80105cbb:	6a 0c                	push   $0xc
  jmp alltraps
80105cbd:	e9 ae fa ff ff       	jmp    80105770 <alltraps>
...
80105cc2:	6a 0d                	push   $0xd
  jmp alltraps
80105cc4:	e9 a7 fa ff ff       	jmp    80105770 <alltraps>
...
80105cc9:	6a 0e                	push   $0xe
  jmp alltraps
80105ccb:	e9 a0 fa ff ff       	jmp    80105770 <alltraps>
...
80105cd2:	6a 0f                	push   $0xf
  jmp alltraps
80105cd4:	e9 97 fa ff ff       	jmp    80105770 <alltraps>
...
80105cdb:	6a 10                	push   $0x10
  jmp alltraps
80105cdd:	e9 8e fa ff ff       	jmp    80105770 <alltraps>
...
80105ce2:	6a 11                	push   $0x11
  jmp alltraps
80105ce4:	e9 87 fa ff ff       	jmp    80105770 <alltraps>
...
80105ceb:	6a 12                	push   $0x12
  jmp alltraps
80105ced:	e9 7e fa ff ff       	jmp    80105770 <alltraps>
...
80105cf4:	6a 13                	push   $0x13
  jmp alltraps
80105cf6:	e9 75 fa ff ff       	jmp    80105770 <alltraps>
...
80105cfd:	6a 14                	push   $0x14
  jmp alltraps
80105cff:	e9 6c fa ff ff       	jmp    80105770 <alltraps>
...
80105d06:	6a 15                	push   $0x15
  jmp alltraps
80105d08:	e9 63 fa ff ff       	jmp    80105770 <alltraps>
...
80105d0f:	6a 16                	push   $0x16
  jmp alltraps
80105d11:	e9 5a fa ff ff       	jmp    80105770 <alltraps>
...
80105d18:	6a 17                	push   $0x17
  jmp alltraps
80105d1a:	e9 51 fa ff ff       	jmp    80105770 <alltraps>
...
80105d21:	6a 18                	push   $0x18
  jmp alltraps
80105d23:	e9 48 fa ff ff       	jmp    80105770 <alltraps>
...
80105d2a:	6a 19                	push   $0x19
  jmp alltraps
80105d2c:	e9 3f fa ff ff       	jmp    80105770 <alltraps>
...
80105d33:	6a 1a                	push   $0x1a
  jmp alltraps
80105d35:	e9 36 fa ff ff       	jmp    80105770 <alltraps>
...
80105d3c:	6a 1b                	push   $0x1b
  jmp alltraps
80105d3e:	e9 2d fa ff ff       	jmp    80105770 <alltraps>
...
80105d45:	6a 1c                	push   $0x1c
  jmp alltraps
80105d47:	e9 24 fa ff ff       	jmp    80105770 <alltraps>
...
80105d4e:	6a 1d                	push   $0x1d
  jmp alltraps
80105d50:	e9 1b fa ff ff       	jmp    80105770 <alltraps>
...
80105d57:	6a 1e                	push   $0x1e
  jmp alltraps
80105d59:	e9 12 fa ff ff       	jmp    80105770 <alltraps>
...
80105d60:	6a 1f                	push   $0x1f
  jmp alltraps
80105d62:	e9 09 fa ff ff       	jmp    80105770 <alltraps>
...
80105d69:	6a 20                	push   $0x20
  jmp alltraps
80105d6b:	e9 00 fa ff ff       	jmp    80105770 <alltraps>
...
80105d72:	6a 21                	push   $0x21
  jmp alltraps
80105d74:	e9 f7 f9 ff ff       	jmp    80105770 <alltraps>
...
80105d7b:	6a 22                	push   $0x22
  jmp alltraps
80105d7d:	e9 ee f9 ff ff       	jmp    80105770 <alltraps>
...
80105d84:	6a 23                	push   $0x23
  jmp alltraps
80105d86:	e9 e5 f9 ff ff       	jmp    80105770 <alltraps>
...
80105d8d:	6a 24                	push   $0x24
  jmp alltraps
80105d8f:	e9 dc f9 ff ff       	jmp    80105770 <alltraps>
...
80105d96:	6a 25                	push   $0x25
  jmp alltraps
80105d98:	e9 d3 f9 ff ff       	jmp    80105770 <alltraps>
...
80105d9f:	6a 26                	push   $0x26
  jmp alltraps
80105da1:	e9 ca f9 ff ff       	jmp    80105770 <alltraps>
...
80105da8:	6a 27                	push   $0x27
  jmp alltraps
80105daa:	e9 c1 f9 ff ff       	jmp    80105770 <alltraps>
...
80105db1:	6a 28                	push   $0x28
  jmp alltraps
80105db3:	e9 b8 f9 ff ff       	jmp    80105770 <alltraps>
...
80105dba:	6a 29                	push   $0x29
  jmp alltraps
80105dbc:	e9 af f9 ff ff       	jmp    80105770 <alltraps>
...
80105dc3:	6a 2a                	push   $0x2a
  jmp alltraps
80105dc5:	e9 a6 f9 ff ff       	jmp    80105770 <alltraps>
...
80105dcc:	6a 2b                	push   $0x2b
  jmp alltraps
80105dce:	e9 9d f9 ff ff       	jmp    80105770 <alltraps>
...
80105dd5:	6a 2c                	push   $0x2c
  jmp alltraps
80105dd7:	e9 94 f9 ff ff       	jmp    80105770 <alltraps>
...
80105dde:	6a 2d                	push   $0x2d
  jmp alltraps
80105de0:	e9 8b f9 ff ff       	jmp    80105770 <alltraps>
...
80105de7:	6a 2e                	push   $0x2e
  jmp alltraps
80105de9:	e9 82 f9 ff ff       	jmp    80105770 <alltraps>
...
80105df0:	6a 2f                	push   $0x2f
  jmp alltraps
80105df2:	e9 79 f9 ff ff       	jmp    80105770 <alltraps>
...
80105df9:	6a 30                	push   $0x30
  jmp alltraps
80105dfb:	e9 70 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e02:	6a 31                	push   $0x31
  jmp alltraps
80105e04:	e9 67 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e0b:	6a 32                	push   $0x32
  jmp alltraps
80105e0d:	e9 5e f9 ff ff       	jmp    80105770 <alltraps>
...
80105e14:	6a 33                	push   $0x33
  jmp alltraps
80105e16:	e9 55 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e1d:	6a 34                	push   $0x34
  jmp alltraps
80105e1f:	e9 4c f9 ff ff       	jmp    80105770 <alltraps>
...
80105e26:	6a 35                	push   $0x35
  jmp alltraps
80105e28:	e9 43 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e2f:	6a 36                	push   $0x36
  jmp alltraps
80105e31:	e9 3a f9 ff ff       	jmp    80105770 <alltraps>
...
80105e38:	6a 37                	push   $0x37
  jmp alltraps
80105e3a:	e9 31 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e41:	6a 38                	push   $0x38
  jmp alltraps
80105e43:	e9 28 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e4a:	6a 39                	push   $0x39
  jmp alltraps
80105e4c:	e9 1f f9 ff ff       	jmp    80105770 <alltraps>
...
80105e53:	6a 3a                	push   $0x3a
  jmp alltraps
80105e55:	e9 16 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e5c:	6a 3b                	push   $0x3b
  jmp alltraps
80105e5e:	e9 0d f9 ff ff       	jmp    80105770 <alltraps>
...
80105e65:	6a 3c                	push   $0x3c
  jmp alltraps
80105e67:	e9 04 f9 ff ff       	jmp    80105770 <alltraps>
...
80105e6e:	6a 3d                	push   $0x3d
  jmp alltraps
80105e70:	e9 fb f8 ff ff       	jmp    80105770 <alltraps>
...
80105e77:	6a 3e                	push   $0x3e
  jmp alltraps
80105e79:	e9 f2 f8 ff ff       	jmp    80105770 <alltraps>
...
80105e80:	6a 3f                	push   $0x3f
  jmp alltraps
80105e82:	e9 e9 f8 ff ff       	jmp    80105770 <alltraps>
...
80105e89:	6a 40                	push   $0x40
  jmp alltraps
80105e8b:	e9 e0 f8 ff ff       	jmp    80105770 <alltraps>
...
80105e92:	6a 41                	push   $0x41
  jmp alltraps
80105e94:	e9 d7 f8 ff ff       	jmp    80105770 <alltraps>
...
80105e9b:	6a 42                	push   $0x42
  jmp alltraps
80105e9d:	e9 ce f8 ff ff       	jmp    80105770 <alltraps>
...
80105ea4:	6a 43                	push   $0x43
  jmp alltraps
80105ea6:	e9 c5 f8 ff ff       	jmp    80105770 <alltraps>
...
80105ead:	6a 44                	push   $0x44
  jmp alltraps
80105eaf:	e9 bc f8 ff ff       	jmp    80105770 <alltraps>
...
80105eb6:	6a 45                	push   $0x45
  jmp alltraps
80105eb8:	e9 b3 f8 ff ff       	jmp    80105770 <alltraps>
...
80105ebf:	6a 46                	push   $0x46
  jmp alltraps
80105ec1:	e9 aa f8 ff ff       	jmp    80105770 <alltraps>
...
80105ec8:	6a 47                	push   $0x47
  jmp alltraps
80105eca:	e9 a1 f8 ff ff       	jmp    80105770 <alltraps>
...
80105ed1:	6a 48                	push   $0x48
  jmp alltraps
80105ed3:	e9 98 f8 ff ff       	jmp    80105770 <alltraps>
...
80105eda:	6a 49                	push   $0x49
  jmp alltraps
80105edc:	e9 8f f8 ff ff       	jmp    80105770 <alltraps>
...
80105ee3:	6a 4a                	push   $0x4a
  jmp alltraps
80105ee5:	e9 86 f8 ff ff       	jmp    80105770 <alltraps>
...
80105eec:	6a 4b                	push   $0x4b
  jmp alltraps
80105eee:	e9 7d f8 ff ff       	jmp    80105770 <alltraps>
...
80105ef5:	6a 4c                	push   $0x4c
  jmp alltraps
80105ef7:	e9 74 f8 ff ff       	jmp    80105770 <alltraps>
...
80105efe:	6a 4d                	push   $0x4d
  jmp alltraps
80105f00:	e9 6b f8 ff ff       	jmp    80105770 <alltraps>
...
80105f07:	6a 4e                	push   $0x4e
  jmp alltraps
80105f09:	e9 62 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f10:	6a 4f                	push   $0x4f
  jmp alltraps
80105f12:	e9 59 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f19:	6a 50                	push   $0x50
  jmp alltraps
80105f1b:	e9 50 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f22:	6a 51                	push   $0x51
  jmp alltraps
80105f24:	e9 47 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f2b:	6a 52                	push   $0x52
  jmp alltraps
80105f2d:	e9 3e f8 ff ff       	jmp    80105770 <alltraps>
...
80105f34:	6a 53                	push   $0x53
  jmp alltraps
80105f36:	e9 35 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f3d:	6a 54                	push   $0x54
  jmp alltraps
80105f3f:	e9 2c f8 ff ff       	jmp    80105770 <alltraps>
...
80105f46:	6a 55                	push   $0x55
  jmp alltraps
80105f48:	e9 23 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f4f:	6a 56                	push   $0x56
  jmp alltraps
80105f51:	e9 1a f8 ff ff       	jmp    80105770 <alltraps>
...
80105f58:	6a 57                	push   $0x57
  jmp alltraps
80105f5a:	e9 11 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f61:	6a 58                	push   $0x58
  jmp alltraps
80105f63:	e9 08 f8 ff ff       	jmp    80105770 <alltraps>
...
80105f6a:	6a 59                	push   $0x59
  jmp alltraps
80105f6c:	e9 ff f7 ff ff       	jmp    80105770 <alltraps>
...
80105f73:	6a 5a                	push   $0x5a
  jmp alltraps
80105f75:	e9 f6 f7 ff ff       	jmp    80105770 <alltraps>
...
80105f7c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f7e:	e9 ed f7 ff ff       	jmp    80105770 <alltraps>
...
80105f85:	6a 5c                	push   $0x5c
  jmp alltraps
80105f87:	e9 e4 f7 ff ff       	jmp    80105770 <alltraps>
...
80105f8e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f90:	e9 db f7 ff ff       	jmp    80105770 <alltraps>
...
80105f97:	6a 5e                	push   $0x5e
  jmp alltraps
80105f99:	e9 d2 f7 ff ff       	jmp    80105770 <alltraps>
...
80105fa0:	6a 5f                	push   $0x5f
  jmp alltraps
80105fa2:	e9 c9 f7 ff ff       	jmp    80105770 <alltraps>
...
80105fa9:	6a 60                	push   $0x60
  jmp alltraps
80105fab:	e9 c0 f7 ff ff       	jmp    80105770 <alltraps>
...
80105fb2:	6a 61                	push   $0x61
  jmp alltraps
80105fb4:	e9 b7 f7 ff ff       	jmp    80105770 <alltraps>
...
80105fbb:	6a 62                	push   $0x62
  jmp alltraps
80105fbd:	e9 ae f7 ff ff       	jmp    80105770 <alltraps>
...
80105fc4:	6a 63                	push   $0x63
  jmp alltraps
80105fc6:	e9 a5 f7 ff ff       	jmp    80105770 <alltraps>
...
80105fcd:	6a 64                	push   $0x64
  jmp alltraps
80105fcf:	e9 9c f7 ff ff       	jmp    80105770 <alltraps>
...
80105fd6:	6a 65                	push   $0x65
  jmp alltraps
80105fd8:	e9 93 f7 ff ff       	jmp    80105770 <alltraps>
...
80105fdf:	6a 66                	push   $0x66
  jmp alltraps
80105fe1:	e9 8a f7 ff ff       	jmp    80105770 <alltraps>
...
80105fe8:	6a 67                	push   $0x67
  jmp alltraps
80105fea:	e9 81 f7 ff ff       	jmp    80105770 <alltraps>
...
80105ff1:	6a 68                	push   $0x68
  jmp alltraps
80105ff3:	e9 78 f7 ff ff       	jmp    80105770 <alltraps>
...
80105ffa:	6a 69                	push   $0x69
  jmp alltraps
80105ffc:	e9 6f f7 ff ff       	jmp    80105770 <alltraps>
...
80106003:	6a 6a                	push   $0x6a
  jmp alltraps
80106005:	e9 66 f7 ff ff       	jmp    80105770 <alltraps>
...
8010600c:	6a 6b                	push   $0x6b
  jmp alltraps
8010600e:	e9 5d f7 ff ff       	jmp    80105770 <alltraps>
...
80106015:	6a 6c                	push   $0x6c
  jmp alltraps
80106017:	e9 54 f7 ff ff       	jmp    80105770 <alltraps>
...
8010601e:	6a 6d                	push   $0x6d
  jmp alltraps
80106020:	e9 4b f7 ff ff       	jmp    80105770 <alltraps>
...
80106027:	6a 6e                	push   $0x6e
  jmp alltraps
80106029:	e9 42 f7 ff ff       	jmp    80105770 <alltraps>
...
80106030:	6a 6f                	push   $0x6f
  jmp alltraps
80106032:	e9 39 f7 ff ff       	jmp    80105770 <alltraps>
...
80106039:	6a 70                	push   $0x70
  jmp alltraps
8010603b:	e9 30 f7 ff ff       	jmp    80105770 <alltraps>
...
80106042:	6a 71                	push   $0x71
  jmp alltraps
80106044:	e9 27 f7 ff ff       	jmp    80105770 <alltraps>
...
8010604b:	6a 72                	push   $0x72
  jmp alltraps
8010604d:	e9 1e f7 ff ff       	jmp    80105770 <alltraps>
...
80106054:	6a 73                	push   $0x73
  jmp alltraps
80106056:	e9 15 f7 ff ff       	jmp    80105770 <alltraps>
...
8010605d:	6a 74                	push   $0x74
  jmp alltraps
8010605f:	e9 0c f7 ff ff       	jmp    80105770 <alltraps>
...
80106066:	6a 75                	push   $0x75
  jmp alltraps
80106068:	e9 03 f7 ff ff       	jmp    80105770 <alltraps>
...
8010606f:	6a 76                	push   $0x76
  jmp alltraps
80106071:	e9 fa f6 ff ff       	jmp    80105770 <alltraps>
...
80106078:	6a 77                	push   $0x77
  jmp alltraps
8010607a:	e9 f1 f6 ff ff       	jmp    80105770 <alltraps>
...
80106081:	6a 78                	push   $0x78
  jmp alltraps
80106083:	e9 e8 f6 ff ff       	jmp    80105770 <alltraps>
...
8010608a:	6a 79                	push   $0x79
  jmp alltraps
8010608c:	e9 df f6 ff ff       	jmp    80105770 <alltraps>
...
80106093:	6a 7a                	push   $0x7a
  jmp alltraps
80106095:	e9 d6 f6 ff ff       	jmp    80105770 <alltraps>
...
8010609c:	6a 7b                	push   $0x7b
  jmp alltraps
8010609e:	e9 cd f6 ff ff       	jmp    80105770 <alltraps>
...
801060a5:	6a 7c                	push   $0x7c
  jmp alltraps
801060a7:	e9 c4 f6 ff ff       	jmp    80105770 <alltraps>
...
801060ae:	6a 7d                	push   $0x7d
  jmp alltraps
801060b0:	e9 bb f6 ff ff       	jmp    80105770 <alltraps>
...
801060b7:	6a 7e                	push   $0x7e
  jmp alltraps
801060b9:	e9 b2 f6 ff ff       	jmp    80105770 <alltraps>
...
801060c0:	6a 7f                	push   $0x7f
  jmp alltraps
801060c2:	e9 a9 f6 ff ff       	jmp    80105770 <alltraps>
...
801060c9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801060ce:	e9 9d f6 ff ff       	jmp    80105770 <alltraps>
...
801060d5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801060da:	e9 91 f6 ff ff       	jmp    80105770 <alltraps>
...
801060e1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801060e6:	e9 85 f6 ff ff       	jmp    80105770 <alltraps>
...
801060ed:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801060f2:	e9 79 f6 ff ff       	jmp    80105770 <alltraps>
...
801060f9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801060fe:	e9 6d f6 ff ff       	jmp    80105770 <alltraps>
...
80106105:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010610a:	e9 61 f6 ff ff       	jmp    80105770 <alltraps>
...
80106111:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106116:	e9 55 f6 ff ff       	jmp    80105770 <alltraps>
...
8010611d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106122:	e9 49 f6 ff ff       	jmp    80105770 <alltraps>
...
80106129:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010612e:	e9 3d f6 ff ff       	jmp    80105770 <alltraps>
...
80106135:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010613a:	e9 31 f6 ff ff       	jmp    80105770 <alltraps>
...
80106141:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106146:	e9 25 f6 ff ff       	jmp    80105770 <alltraps>
...
8010614d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106152:	e9 19 f6 ff ff       	jmp    80105770 <alltraps>
...
80106159:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010615e:	e9 0d f6 ff ff       	jmp    80105770 <alltraps>
...
80106165:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010616a:	e9 01 f6 ff ff       	jmp    80105770 <alltraps>
...
80106171:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106176:	e9 f5 f5 ff ff       	jmp    80105770 <alltraps>
...
8010617d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106182:	e9 e9 f5 ff ff       	jmp    80105770 <alltraps>
...
80106189:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010618e:	e9 dd f5 ff ff       	jmp    80105770 <alltraps>
...
80106195:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010619a:	e9 d1 f5 ff ff       	jmp    80105770 <alltraps>
...
801061a1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801061a6:	e9 c5 f5 ff ff       	jmp    80105770 <alltraps>
...
801061ad:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801061b2:	e9 b9 f5 ff ff       	jmp    80105770 <alltraps>
...
801061b9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801061be:	e9 ad f5 ff ff       	jmp    80105770 <alltraps>
...
801061c5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801061ca:	e9 a1 f5 ff ff       	jmp    80105770 <alltraps>
...
801061d1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801061d6:	e9 95 f5 ff ff       	jmp    80105770 <alltraps>
...
801061dd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801061e2:	e9 89 f5 ff ff       	jmp    80105770 <alltraps>
...
801061e9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801061ee:	e9 7d f5 ff ff       	jmp    80105770 <alltraps>
...
801061f5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801061fa:	e9 71 f5 ff ff       	jmp    80105770 <alltraps>
...
80106201:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106206:	e9 65 f5 ff ff       	jmp    80105770 <alltraps>
...
8010620d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106212:	e9 59 f5 ff ff       	jmp    80105770 <alltraps>
...
80106219:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010621e:	e9 4d f5 ff ff       	jmp    80105770 <alltraps>
...
80106225:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010622a:	e9 41 f5 ff ff       	jmp    80105770 <alltraps>
...
80106231:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106236:	e9 35 f5 ff ff       	jmp    80105770 <alltraps>
...
8010623d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106242:	e9 29 f5 ff ff       	jmp    80105770 <alltraps>
...
80106249:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010624e:	e9 1d f5 ff ff       	jmp    80105770 <alltraps>
...
80106255:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010625a:	e9 11 f5 ff ff       	jmp    80105770 <alltraps>
...
80106261:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106266:	e9 05 f5 ff ff       	jmp    80105770 <alltraps>
...
8010626d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106272:	e9 f9 f4 ff ff       	jmp    80105770 <alltraps>
...
80106279:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010627e:	e9 ed f4 ff ff       	jmp    80105770 <alltraps>
...
80106285:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010628a:	e9 e1 f4 ff ff       	jmp    80105770 <alltraps>
...
80106291:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106296:	e9 d5 f4 ff ff       	jmp    80105770 <alltraps>
...
8010629d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801062a2:	e9 c9 f4 ff ff       	jmp    80105770 <alltraps>
...
801062a9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801062ae:	e9 bd f4 ff ff       	jmp    80105770 <alltraps>
...
801062b5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801062ba:	e9 b1 f4 ff ff       	jmp    80105770 <alltraps>
...
801062c1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801062c6:	e9 a5 f4 ff ff       	jmp    80105770 <alltraps>
...
801062cd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801062d2:	e9 99 f4 ff ff       	jmp    80105770 <alltraps>
...
801062d9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801062de:	e9 8d f4 ff ff       	jmp    80105770 <alltraps>
...
801062e5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801062ea:	e9 81 f4 ff ff       	jmp    80105770 <alltraps>
...
801062f1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801062f6:	e9 75 f4 ff ff       	jmp    80105770 <alltraps>
...
801062fd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106302:	e9 69 f4 ff ff       	jmp    80105770 <alltraps>
...
80106309:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010630e:	e9 5d f4 ff ff       	jmp    80105770 <alltraps>
...
80106315:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010631a:	e9 51 f4 ff ff       	jmp    80105770 <alltraps>
...
80106321:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106326:	e9 45 f4 ff ff       	jmp    80105770 <alltraps>
...
8010632d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106332:	e9 39 f4 ff ff       	jmp    80105770 <alltraps>
...
80106339:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010633e:	e9 2d f4 ff ff       	jmp    80105770 <alltraps>
...
80106345:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010634a:	e9 21 f4 ff ff       	jmp    80105770 <alltraps>
...
80106351:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106356:	e9 15 f4 ff ff       	jmp    80105770 <alltraps>
...
8010635d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106362:	e9 09 f4 ff ff       	jmp    80105770 <alltraps>
...
80106369:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010636e:	e9 fd f3 ff ff       	jmp    80105770 <alltraps>
...
80106375:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010637a:	e9 f1 f3 ff ff       	jmp    80105770 <alltraps>
...
80106381:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106386:	e9 e5 f3 ff ff       	jmp    80105770 <alltraps>
...
8010638d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106392:	e9 d9 f3 ff ff       	jmp    80105770 <alltraps>
...
80106399:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010639e:	e9 cd f3 ff ff       	jmp    80105770 <alltraps>
...
801063a5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801063aa:	e9 c1 f3 ff ff       	jmp    80105770 <alltraps>
...
801063b1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801063b6:	e9 b5 f3 ff ff       	jmp    80105770 <alltraps>
...
801063bd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801063c2:	e9 a9 f3 ff ff       	jmp    80105770 <alltraps>
...
801063c9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801063ce:	e9 9d f3 ff ff       	jmp    80105770 <alltraps>
...
801063d5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801063da:	e9 91 f3 ff ff       	jmp    80105770 <alltraps>
...
801063e1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801063e6:	e9 85 f3 ff ff       	jmp    80105770 <alltraps>
...
801063ed:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801063f2:	e9 79 f3 ff ff       	jmp    80105770 <alltraps>
...
801063f9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801063fe:	e9 6d f3 ff ff       	jmp    80105770 <alltraps>
...
80106405:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010640a:	e9 61 f3 ff ff       	jmp    80105770 <alltraps>
...
80106411:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106416:	e9 55 f3 ff ff       	jmp    80105770 <alltraps>
...
8010641d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106422:	e9 49 f3 ff ff       	jmp    80105770 <alltraps>
...
80106429:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010642e:	e9 3d f3 ff ff       	jmp    80105770 <alltraps>
...
80106435:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010643a:	e9 31 f3 ff ff       	jmp    80105770 <alltraps>
...
80106441:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106446:	e9 25 f3 ff ff       	jmp    80105770 <alltraps>
...
8010644d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106452:	e9 19 f3 ff ff       	jmp    80105770 <alltraps>
...
80106459:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010645e:	e9 0d f3 ff ff       	jmp    80105770 <alltraps>
...
80106465:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010646a:	e9 01 f3 ff ff       	jmp    80105770 <alltraps>
...
80106471:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106476:	e9 f5 f2 ff ff       	jmp    80105770 <alltraps>
...
8010647d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106482:	e9 e9 f2 ff ff       	jmp    80105770 <alltraps>
...
80106489:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010648e:	e9 dd f2 ff ff       	jmp    80105770 <alltraps>
...
80106495:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010649a:	e9 d1 f2 ff ff       	jmp    80105770 <alltraps>
...
801064a1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801064a6:	e9 c5 f2 ff ff       	jmp    80105770 <alltraps>
...
801064ad:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801064b2:	e9 b9 f2 ff ff       	jmp    80105770 <alltraps>
...
801064b9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801064be:	e9 ad f2 ff ff       	jmp    80105770 <alltraps>
...
801064c5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801064ca:	e9 a1 f2 ff ff       	jmp    80105770 <alltraps>
...
801064d1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801064d6:	e9 95 f2 ff ff       	jmp    80105770 <alltraps>
...
801064dd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801064e2:	e9 89 f2 ff ff       	jmp    80105770 <alltraps>
...
801064e9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801064ee:	e9 7d f2 ff ff       	jmp    80105770 <alltraps>
...
801064f5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801064fa:	e9 71 f2 ff ff       	jmp    80105770 <alltraps>
...
80106501:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106506:	e9 65 f2 ff ff       	jmp    80105770 <alltraps>
...
8010650d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106512:	e9 59 f2 ff ff       	jmp    80105770 <alltraps>
...
80106519:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010651e:	e9 4d f2 ff ff       	jmp    80105770 <alltraps>
...
80106525:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010652a:	e9 41 f2 ff ff       	jmp    80105770 <alltraps>
...
80106531:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106536:	e9 35 f2 ff ff       	jmp    80105770 <alltraps>
...
8010653d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106542:	e9 29 f2 ff ff       	jmp    80105770 <alltraps>
...
80106549:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010654e:	e9 1d f2 ff ff       	jmp    80105770 <alltraps>
...
80106555:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010655a:	e9 11 f2 ff ff       	jmp    80105770 <alltraps>
...
80106561:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106566:	e9 05 f2 ff ff       	jmp    80105770 <alltraps>
...
8010656d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106572:	e9 f9 f1 ff ff       	jmp    80105770 <alltraps>
...
80106579:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010657e:	e9 ed f1 ff ff       	jmp    80105770 <alltraps>
...
80106585:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010658a:	e9 e1 f1 ff ff       	jmp    80105770 <alltraps>
...
80106591:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106596:	e9 d5 f1 ff ff       	jmp    80105770 <alltraps>
...
8010659d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801065a2:	e9 c9 f1 ff ff       	jmp    80105770 <alltraps>
...
801065a9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801065ae:	e9 bd f1 ff ff       	jmp    80105770 <alltraps>
...
801065b5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801065ba:	e9 b1 f1 ff ff       	jmp    80105770 <alltraps>
...
801065c1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801065c6:	e9 a5 f1 ff ff       	jmp    80105770 <alltraps>
...
801065cd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801065d2:	e9 99 f1 ff ff       	jmp    80105770 <alltraps>
...
801065d9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801065de:	e9 8d f1 ff ff       	jmp    80105770 <alltraps>
...
801065e5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801065ea:	e9 81 f1 ff ff       	jmp    80105770 <alltraps>
...
801065f1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801065f6:	e9 75 f1 ff ff       	jmp    80105770 <alltraps>
...
801065fd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106602:	e9 69 f1 ff ff       	jmp    80105770 <alltraps>
...
80106609:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010660e:	e9 5d f1 ff ff       	jmp    80105770 <alltraps>
...
80106615:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010661a:	e9 51 f1 ff ff       	jmp    80105770 <alltraps>
...
80106621:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106626:	e9 45 f1 ff ff       	jmp    80105770 <alltraps>
...
8010662d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106632:	e9 39 f1 ff ff       	jmp    80105770 <alltraps>
...
80106639:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010663e:	e9 2d f1 ff ff       	jmp    80105770 <alltraps>
...
80106645:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010664a:	e9 21 f1 ff ff       	jmp    80105770 <alltraps>
...
80106651:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106656:	e9 15 f1 ff ff       	jmp    80105770 <alltraps>
...
8010665d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106662:	e9 09 f1 ff ff       	jmp    80105770 <alltraps>
...
80106669:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010666e:	e9 fd f0 ff ff       	jmp    80105770 <alltraps>
...
80106675:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010667a:	e9 f1 f0 ff ff       	jmp    80105770 <alltraps>
...
80106681:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106686:	e9 e5 f0 ff ff       	jmp    80105770 <alltraps>
...
8010668d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106692:	e9 d9 f0 ff ff       	jmp    80105770 <alltraps>
...
80106699:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010669e:	e9 cd f0 ff ff       	jmp    80105770 <alltraps>
...
801066a5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801066aa:	e9 c1 f0 ff ff       	jmp    80105770 <alltraps>
...
801066b1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801066b6:	e9 b5 f0 ff ff       	jmp    80105770 <alltraps>
...
801066bd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801066c2:	e9 a9 f0 ff ff       	jmp    80105770 <alltraps>
...
80106714:	e8 a7 bd ff ff       	call   801024c0 <kalloc>
...
8010672a:	e8 11 de ff ff       	call   80104540 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801067cd:	68 d4 78 10 80       	push   $0x801078d4
...
80106824:	e8 e7 ba ff ff       	call   80102310 <kfree>
      *pte = 0;
...
8010689a:	c7 80 18 28 11 80 ff 	movl   $0xffff,-0x7feed7e8(%eax)
801068a1:	ff 00 00 
801068a4:	c7 80 1c 28 11 80 00 	movl   $0xcf9a00,-0x7feed7e4(%eax)
801068ab:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801068ae:	c7 80 20 28 11 80 ff 	movl   $0xffff,-0x7feed7e0(%eax)
801068b5:	ff 00 00 
801068b8:	c7 80 24 28 11 80 00 	movl   $0xcf9200,-0x7feed7dc(%eax)
801068bf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801068c2:	c7 80 28 28 11 80 ff 	movl   $0xffff,-0x7feed7d8(%eax)
801068c9:	ff 00 00 
801068cc:	c7 80 2c 28 11 80 00 	movl   $0xcffa00,-0x7feed7d4(%eax)
801068d3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801068d6:	c7 80 30 28 11 80 ff 	movl   $0xffff,-0x7feed7d0(%eax)
801068dd:	ff 00 00 
801068e0:	c7 80 34 28 11 80 00 	movl   $0xcff200,-0x7feed7cc(%eax)
801068e7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
801068ea:	05 10 28 11 80       	add    $0x80112810,%eax
  pd[1] = (uint)p;
...
80106954:	0f 84 c2 00 00 00    	je     80106a1c <switchuvm+0xec>
  pushcli();
8010695a:	e8 01 da ff ff       	call   80104360 <pushcli>
...
80106a5b:	77 49                	ja     80106aa6 <inituvm+0x66>
  mem = kalloc();
80106a5d:	e8 5e ba ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106a6f:	e8 cc da ff ff       	call   80104540 <memset>
...
80106aa0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106aa1:	e9 4a db ff ff       	jmp    801045f0 <memmove>
    panic("inituvm: more than a page");
80106aa6:	83 ec 0c             	sub    $0xc,%esp
80106aa9:	68 19 79 10 80       	push   $0x80107919
...
80106b31:	e8 2a ae ff ff       	call   80101960 <readi>
...
80106bcb:	e8 70 d9 ff ff       	call   80104540 <memset>
...
80106bf9:	0f 86 81 00 00 00    	jbe    80106c80 <allocuvm+0x100>
    mem = kalloc();
80106bff:	e8 bc b8 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106c0d:	68 51 79 10 80       	push   $0x80107951
...
80106c43:	68 69 79 10 80       	push   $0x80107969
...
80106c6b:	e8 a0 b6 ff ff       	call   80102310 <kfree>
      return 0;
...
80106d2e:	e8 dd b5 ff ff       	call   80102310 <kfree>
...
80106d43:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106d44:	e9 c7 b5 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106d49:	83 ec 0c             	sub    $0xc,%esp
80106d4c:	68 85 79 10 80       	push   $0x80107985
...
80106d65:	e8 56 b7 ff ff       	call   801024c0 <kalloc>
...
80106d80:	e8 bb d7 ff ff       	call   80104540 <memset>
...
80106e1f:	68 96 79 10 80       	push   $0x80107996
...
80106e70:	e8 7b d7 ff ff       	call   801045f0 <memmove>
...
80106ec5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106ec8:	e8 f3 b5 ff ff       	call   801024c0 <kalloc>
...
80106f9f:	e8 4c d6 ff ff       	call   801045f0 <memmove>
    len -= n;
    buf += n;
